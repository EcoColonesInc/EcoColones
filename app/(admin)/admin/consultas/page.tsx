...
import { getAllCountries, getAllProvinces, getAllCities, getAllDistricts } from "@/lib/api/locations";

export const revalidate = 0;

export default async function AdminConsultasPage() {
  const [personsRes, pointsRes, countriesRes, provincesRes, citiesRes, districtsRes] = await Promise.all([
    getAllPersons(),
    getAllUsersPoints(),
    getAllCountries(),
    getAllProvinces(),
